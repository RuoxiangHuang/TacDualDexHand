...
from .gelsighthand_cfg import GelSightHandCfg

"""Configuration for simulating the Gelsight Hand via GPU-Taxim and FOTS."""

GELSIGHT_HAND_TAXIM_FOTS_CFG = GelSightHandCfg()
GELSIGHT_HAND_TAXIM_FOTS_CFG = GELSIGHT_HAND_TAXIM_FOTS_CFG.replace(
    ...
    optical_sim_cfg=TaximSimulatorCfg(
        ...
        gelpad_height=GELSIGHT_HAND_TAXIM_FOTS_CFG.gelpad_dimensions.height,
