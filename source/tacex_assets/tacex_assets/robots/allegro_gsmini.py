...
* :obj:`ALLEGRO_HAND_CFG`: Allegro Hand with implicit actuator model and GelSight Minis.
...
ALLEGRO_HAND_GSMINI_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{TACEX_ASSETS_DATA_DIR}/Robots/allegro_hand_gsmini.usd",
