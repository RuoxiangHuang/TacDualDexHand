...
from tacex_tasks.shadowhand_pick_up_object.shadowhand_pick_up_object_env import (
...
def main():
    ...
    env._window = CustomEnvWindow(env, window_name="ShadowHand Dual-Arm Fixed Grasp Pose")
